    ...
    def update_renderer(self, pcd, bb_list, wait_time=0):
        ...
        if not self.__initialized:
            ...
            for dim_of_bb in bb_list:
               ...
               if category == "movable_object.debris":
                  colors = [[1, 0, 0] for i in range(len(edges))] 
               ...
               if category == "vehicle.car":
                  colors = [[0.5, 0, 0] for i in range(len(edges))] 
                  
               if category == "human.pedestrian.adult":
                  colors = [[0, 0.5, 0] for i in range(len(edges))]
                  
               if category == "vehicle.construction":
                  colors = [[0, 0, 0.5] for i in range(len(edges))]
                  
               if category == "movable_object.pushable_pullable":
                  colors = [[0.5, 0.5, 0] for i in range(len(edges))] 
                  
               if category == "human.pedestrian.construction_worker":
                  colors = [[0, 0.5, 0.5] for i in range(len(edges))]
                  
               if category == "vehicle.bus.rigid":
                  colors = [[0.5, 0, 0.5] for i in range(len(edges))]
                  
               if category == "animal":
                  colors = [[0.5, 0.5, 0.5] for i in range(len(edges))] 
                  
               if category == "static_object.bicycle_rack":
                  colors = [[0.7, 0, 0] for i in range(len(edges))] 
                  
               if category == "vehicle.emergency.ambulance":
                  colors = [[0, 0.7, 0] for i in range(len(edges))] 
                  
               if category == "vehicle.emergency.police":
                  colors = [[0, 0, 0.7] for i in range(len(edges))] 
                  
               if category == "vehicle.bus.bendy":
                  colors = [[0.7, 0.7, 0] for i in range(len(edges))] 
                  
               if category == "human.pedestrian.child":
                  colors = [[0, 0.7, 0.7] for i in range(len(edges))] 
                  
               if category == "human.pedestrian.police_officer":
                  colors = [[0.7, 0, 0.7] for i in range(len(edges))] 
                  
               if category == "human.pedestrian.personal_mobility":
                  colors = [[0.8, 0, 0] for i in range(len(edges))] 
                  
               if category == "human.pedestrian.stroller":
                  colors = [[0, 0.8, 0] for i in range(len(edges))]
                  
               if category == "human.pedestrian.wheelchair":
                  colors = [[0, 0, 0.8] for i in range(len(edges))] 
                  
               if category == "vehicle.trailer":
                  colors = [[0.8, 0, 0.8] for i in range(len(edges))] 
...
for i in range(len(nusc.scene)):
   ...
   while(flag==1):
      ...
      for k in range(len(annotation_token_list)):
         ...
         dim_of_box = [box.center, size[1], size[0], size[2], rotation_angle, category]
